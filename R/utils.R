...
#'
#' Data Eras:
#' - Era 1 (2010-2026): Modern schema via data.wa.gov Socrata API
#'   - 2010-2014: "Student Enrollment" datasets (same schema)
#'   - 2015-2026: "Report Card Enrollment" datasets
...
get_available_years <- function() {
  ...
  # Modern schema datasets: 2010-2026 (Student Enrollment + Report Card Enrollment)
...
#' - 2010-2014: "Student Enrollment" datasets (same schema)
#'
#' @param end_year School year end (e.g., 2026 for 2025-26 school year)
...
get_dataset_id <- function(end_year) {
  ...
  # Report Card Enrollment datasets (2015-2026)
