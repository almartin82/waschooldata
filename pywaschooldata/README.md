...
Python wrapper for Washington school enrollment data.

This is a thin rpy2 wrapper around the [waschooldata](https://github.com/almartin82/waschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `waschooldata` R package installed
...
# In R:
# remotes::install_github("almartin82/waschooldata")

# Then install the Python package
pip install pywaschooldata
```
...
# Fetch one year
df = wa.fetch_enr(2025)

# Fetch multiple years
df_multi = wa.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
