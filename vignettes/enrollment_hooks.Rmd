---
title: "10 Insights from Washington School Enrollment Data"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{10 Insights from Washington School Enrollment Data}
...
This vignette explores Washington's public school enrollment data, surfacing key trends across 15 years of data (2010-2024).
...
ggplot(state_totals, aes(x = end_year, y = n_students)) +
  ...
  labs(
    title = "Washington Public School Enrollment (2010-2024)",
...
demographics <- enr |>
  filter(is_state, grade_level == "TOTAL",
         ...
         end_year %in% c(2010, 2015, 2020, 2024)) |>
...
enr |>
  ...
  labs(
    title = "Washington's Shifting Demographics (2010-2024)",
...
growth_rates <- enr |>
  ...
  mutate(
    change = yr_2024 - yr_2015,
    pct_change = round((yr_2024 - yr_2015) / yr_2015 * 100, 1)
  ) |>
...
growth_rates |>
  ...
  labs(
    title = "Fastest Growing Large Districts (2015-2024)",
...
## 10. 15 years of data capture major shifts

Washington's enrollment data spans 2010-2024, documenting the Amazon/Microsoft boom, pandemic disruption, and demographic transformation.
